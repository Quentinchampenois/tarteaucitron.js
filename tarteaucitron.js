...
var tarteaucitron = {
    ...
    tarteaucitron.addInternalScript(pathToLang, '', function() {
      ...
      tarteaucitron.addInternalScript(pathToServices, '', function() {
        ...
        if (tarteaucitron.parameters.groupServices === true) {
          var tacGroupStyle = document.createElement('style');
          tacGroupStyle.innerHTML = '.tarteaucitronTitle{display:none}';
          document.head.appendChild(tacGroupStyle);
  ...
  'sendEvent': function(eventKey) {
    if (eventKey !== undefined) {
      ...
      document.dispatchEvent(sendEventItem);
    }
  },
